...
function SyncAppRow({ app }: { app: SyncDashboardRow }) {
  ...
  const handleCancel = async () => {
    ...
    try {
      await fetch(`/api/sync?request_id=${requestId}`, {
        method: 'DELETE',
      })
